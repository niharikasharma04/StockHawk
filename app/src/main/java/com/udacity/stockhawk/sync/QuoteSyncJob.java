...
import com.udacity.stockhawk.widget.StockHawkAppWidget;
    ...
    static void getQuotes(final Context context) {
        ...
        try {
            ...
            if (cursor.getCount() > 0) {
                ...
                Log.d("prefutils","stockArray="+stockArray);
                Log.d("prefutils","stockCopy="+stockCopy);}
                else{
                Log.d("pref utils","in else");
            ...
            while (iterator.hasNext()) {
                ...
                if ((stock.getName() == null) && (null == quote.getPreviousClose())){
                ...
                Intent dataUpdatedIntent = new Intent(context, StockHawkAppWidget.class);
